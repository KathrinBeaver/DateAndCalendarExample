...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        useDateExample();
        useCalendarExample();
        partsOfCalendarExample();
        setDateManually();
        substractAndCompareDate();
    }

    private static void someDateClasses() {
        Date date = new Date();
    ...
    private static void useDateExample() {
    ...
    private static void useCalendarExample() {
    ...
    private static void partsOfCalendarExample() {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy MMMM dd HH:mm:ss");
    ...
    private static void setDateManually() {
    ...
    private static void substractAndCompareDate() {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy MMM dd");

        Calendar calendar = new GregorianCalendar(2020, 10, 28);
